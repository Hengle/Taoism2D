...
function SpriteAnimateRenderable(myTexture) {
    ...
    Renderable.prototype._setShader.call(this, engine.defaultResources.getSpriteShader());
...
engine.core.inheritPrototype(SpriteAnimateRenderable, SpriteRenderable);
...
SpriteAnimateRenderable.prototype.setSpriteSequence = function (
    ...
    let texInfo = engine.ResourceMap.retrieveAsset(this.mTexture);
