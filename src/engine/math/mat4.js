Object.assign(engine, (function () {
    ...
    Object.assign(Mat4.prototype, {
        /**
         * @function
         * @name engine.Mat4#add2
         * @description Adds the specified 4x4 matrices together and stores the result in
         * the current instance.
         * @param {engine.Mat4} lhs The 4x4 matrix used as the first operand of the addition.
         * @param {engine.Mat4} rhs The 4x4 matrix used as the second operand of the addition.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * var m = new engine.Mat4();
         *
         * m.add2(engine.Mat4.IDENTITY, engine.Mat4.ONE);
         *
        ...
        /**
         * @function
         * @name engine.Mat4#clone
         * @description Creates a duplicate of the specified matrix.
         * @returns {engine.Mat4} A duplicate matrix.
         * @example
         * var src = new engine.Mat4().setFromEulerAngles(10, 20, 30);
         * var dst = src.clone();
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"));
         */
        clone: function () {
            return new engine.Mat4().copy(this);
        },

        /**
         * @function
         * @name engine.Mat4#copy
         * @description Copies the contents of a source 4x4 matrix to a destination 4x4 matrix.
         * @param {engine.Mat4} rhs A 4x4 matrix to be copied.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * var src = new engine.Mat4().setFromEulerAngles(10, 20, 30);
         * var dst = new engine.Mat4();
         * dst.copy(src);
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"));
         */
        copy: function (rhs) {
        ...
        /**
         * @function
         * @name engine.Mat4#equals
         * @description Reports whether two matrices are equal.
         * @param {engine.Mat4} rhs The other matrix.
         * @returns {Boolean} true if the matrices are equal and false otherwise.
         * @example
         * var a = new engine.Mat4().setFromEulerAngles(10, 20, 30);
         * var b = new engine.Mat4();
        ...
        /**
         * @function
         * @name engine.Mat4#mul2
         * @description Multiplies the specified 4x4 matrices together and stores the result in
         * the current instance.
         * @param {engine.Mat4} lhs The 4x4 matrix used as the first multiplicand of the operation.
         * @param {engine.Mat4} rhs The 4x4 matrix used as the second multiplicand of the operation.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * var a = new engine.Mat4().setFromEulerAngles(10, 20, 30);
         * var b = new engine.Mat4().setFromAxisAngle(engine.Vec3.UP, 180);
         * var r = new engine.Mat4();
         *
         * // r = a * b
         * r.mul2(a, b);
         *
        ...
        /**
         * @function
         * @name engine.Mat4#transformPoint
         * @description Transforms a 3-dimensional point by a 4x4 matrix.
         * @param {engine.Vec3} vec The 3-dimensional point to be transformed.
         * @param {engine.Vec3} [res] An optional 3-dimensional point to receive the result of the transformation.
         * @returns {engine.Vec3} The input point v transformed by the current instance.
         * @example
         * // Create a 3-dimensional point
         * var v = new engine.Vec3(1, 2, 3);
         *
         * // Create a 4x4 rotation matrix
         * var m = new engine.Mat4().setFromEulerAngles(10, 20, 30);
         *
        ...
        transformPoint: function (vec, res) {
            ...
            res = (res === undefined) ? new engine.Vec3() : res;
        ...
        /**
         * @function
         * @name engine.Mat4#transformVector
         * @description Transforms a 3-dimensional vector by a 4x4 matrix.
         * @param {engine.Vec3} vec The 3-dimensional vector to be transformed.
         * @param {engine.Vec3} [res] An optional 3-dimensional vector to receive the result of the transformation.
         * @returns {engine.Vec3} The input vector v transformed by the current instance.
         * @example
        ...
        /**
         * @function
         * @name engine.Mat4#transformVec4
         * @description Transforms a 4-dimensional vector by a 4x4 matrix.
         * @param {engine.Vec4} vec The 4-dimensional vector to be transformed.
         * @param {engine.Vec4} [res] An optional 4-dimensional vector to receive the result of the transformation.
         * @returns {engine.Vec4} The input vector v transformed by the current instance.
         * @example
         * // Create an input 4-dimensional vector
         * var v = new engine.Vec4(1, 2, 3, 4);
         *
         * // Create an output 4-dimensional vector
         * var result = new engine.Vec4();
         *
         * // Create a 4x4 rotation matrix
         * var m = new engine.Mat4().setFromEulerAngles(10, 20, 30);
         *
        ...
        transformVec4: function (vec, res) {
            ...
            res = (res === undefined) ? new engine.Vec4() : res;
         ...
         * @param {engine.Vec3} position 3-d vector holding view position.
         * @param {engine.Vec3} target 3-d vector holding reference point.
         * @param {engine.Vec3} up 3-d vector holding the up direction.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * var position = new engine.Vec3(10, 10, 10);
         * var target = new engine.Vec3(0, 0, 0);
         * var up = new engine.Vec3(0, 1, 0);
         * var m = new engine.Mat4().setLookAt(position, target, up);
         */
        setLookAt: (function () {
            var x, y, z;
         ...
         * var f = engine.Mat4().setFrustum(-2, 2, -1, 1, 1, 1000);
         */
        ...
        /**
         * @function
         * @name engine.Mat4#setPerspective
         ...
         * @example
         * // Create a 4x4 perspective projection matrix
         * var persp = engine.Mat4().setPerspective(45, 16 / 9, 1, 1000);
         */
         ...
         * var ortho = engine.Mat4().ortho(-2, 2, -2, 2, 1, 1000);
         */
        ...
        /**
         * @function
         * @name engine.Mat4#setFromAxisAngle
         ...
         * @param {engine.Vec3} axis The normalized axis vector around which to rotate.
         * @param {Number} angle The angle of rotation in degrees.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * // Create a 4x4 rotation matrix
         * var rm = new engine.Mat4().setFromAxisAngle(engine.Vec3.UP, 90);
         */
        setFromAxisAngle: function (axis, angle) {
            var x, y, z, c, s, t, tx, ty, m;

            angle *= engine.math.DEG_TO_RAD;
         ...
         * var tm = new engine.Mat4().setTranslate(10, 10, 10);
         */
         ...
         * var sm = new engine.Mat4().setScale(10, 10, 10);
         */
        ...
        /**
         * @function
         * @name engine.Mat4#invert
         * @description Sets the specified matrix to its inverse.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * // Create a 4x4 rotation matrix of 180 degrees around the y-axis
         * var rot = new engine.Mat4().setFromAxisAngle(engine.Vec3.UP, 180);
         *
         * // Invert in place
         * rot.invert();
         */
        ...
        /**
         * @function
         * @name engine.Mat4#setTRS
         * @description Sets the specified matrix to the concatenation of a translation, a
         * quaternion rotation and a scale.
         * @param {engine.Vec3} t A 3-d vector translation.
         * @param {engine.Quat} r A quaternion rotation.
         * @param {engine.Vec3} s A 3-d vector scale.
         * @returns {engine.Mat4} Self for chaining.
         * @example
         * var t = new engine.Vec3(10, 20, 30);
         * var r = new engine.Quat();
         * var s = new engine.Vec3(2, 2, 2);
         *
         * var m = new engine.Mat4();
         * m.setTRS(t, r, s);
         */
        ...
        /**
         * @function
         * @name engine.Mat4#getTranslation
         * @description Extracts the translational component from the specified 4x4 matrix.
         * @param {engine.Vec3} [t] The vector to receive the translation of the matrix.
         * @returns {engine.Vec3} The translation of the specified 4x4 matrix.
         * @example
         * // Create a 4x4 matrix
         * var m = new engine.Mat4();
         *
         * // Query the z-axis component
         * var t = new engine.Vec3();
         * m.getTranslation(t);
         */
        getTranslation: function (t) {
            t = (t === undefined) ? new engine.Vec3() : t;
        ...
        /**
         * @function
         * @name engine.Mat4#getX
         * @description Extracts the x-axis from the specified 4x4 matrix.
         * @param {engine.Vec3} [x] The vector to receive the x axis of the matrix.
         * @returns {engine.Vec3} The x-axis of the specified 4x4 matrix.
         * @example
         * // Create a 4x4 matrix
         * var m = new engine.Mat4();
         *
         * // Query the z-axis component
         * var x = new engine.Vec3();
         * m.getX(x);
         */
        getX: function (x) {
            x = (x === undefined) ? new engine.Vec3() : x;
        ...
        /**
         * @function
         * @name engine.Mat4#getY
         * @description Extracts the y-axis from the specified 4x4 matrix.
         * @param {engine.Vec3} [y] The vector to receive the y axis of the matrix.
         * @returns {engine.Vec3} The y-axis of the specified 4x4 matrix.
         * @example
         * // Create a 4x4 matrix
         * var m = new engine.Mat4();
         *
         * // Query the z-axis component
         * var y = new engine.Vec3();
         * m.getY(y);
         */
        getY: function (y) {
            y = (y === undefined) ? new engine.Vec3() : y;
        ...
        /**
         * @function
         * @name engine.Mat4#getZ
         * @description Extracts the z-axis from the specified 4x4 matrix.
         * @param {engine.Vec3} [z] The vector to receive the z axis of the matrix.
         * @returns {engine.Vec3} The z-axis of the specified 4x4 matrix.
         * @example
         * // Create a 4x4 matrix
         * var m = new engine.Mat4();
         *
         * // Query the z-axis component
         * var z = new engine.Vec3();
         * m.getZ(z);
         */
        getZ: function (z) {
            z = (z === undefined) ? new engine.Vec3() : z;
        ...
        /**
         * @function
         * @name engine.Mat4#getScale
         * @description Extracts the scale component from the specified 4x4 matrix.
         * @param {engine.Vec3} [scale] Vector to receive the scale.
         * @returns {engine.Vec3} The scale in X, Y and Z of the specified 4x4 matrix.
         * @example
         * // Create a 4x4 scale matrix
         * var m = new engine.Mat4().scale(2, 3, 4);
         *
        ...
        getScale: (function () {
            ...
            return function (scale) {
                scale = (scale === undefined) ? new engine.Vec3() : scale;
        ...
        /**
         * @function
         * @name engine.Mat4#setFromEulerAngles
        ...
        setFromEulerAngles: function (ex, ey, ez) {
            ...
            ex *= engine.math.DEG_TO_RAD;
            ey *= engine.math.DEG_TO_RAD;
            ez *= engine.math.DEG_TO_RAD;
        ...
        /**
         * @function
         * @name engine.Mat4#getEulerAngles
         ...
         * @param {engine.Vec3} [eulers] A 3-d vector to receive the Euler angles.
         * @returns {engine.Vec3} A 3-d vector containing the Euler angles.
         * @example
         * // Create a 4x4 rotation matrix of 45 degrees around the y-axis
         * var m = new engine.Mat4().setFromAxisAngle(engine.Vec3.UP, 45);
         *
         * var eulers = m.getEulerAngles();
         */
        getEulerAngles: (function () {
            var scale = new engine.Vec3();

            return function (eulers) {
                var x, y, z, sx, sy, sz, m, halfPi;

                eulers = (eulers === undefined) ? new engine.Vec3() : eulers;
                ...
                return eulers.set(x, y, z).scale(engine.math.RAD_TO_DEG);
            };
        }()),

        /**
         * @function
         * @name engine.Mat4#toString
