    ...
    Object.assign(CurveEvaluator.prototype, {
        ...
        evaluate: function (time, forceReset) {
            ...
            if (type === engine.CURVE_STEP) {
                ...
                if (type === engine.CURVE_LINEAR) {
                    // linear
                    result = engine.math.lerp(this._p0, this._p1, t);
                } else if (type === engine.CURVE_SMOOTHSTEP) {
                    // smoothstep
                    result = engine.math.lerp(this._p0, this._p1, t * t * (3 - 2 * t));
                } else {
                    // curve
        ...
        _isHermite: function () {
            return this._curve.type === engine.CURVE_CATMULL ||
                   this._curve.type === engine.CURVE_CARDINAL ||
                   this._curve.type === engine.CURVE_SPLINE;
        },
        ...
        _calcTangents: function (keys, index) {
            ...
            if (this._curve.type === engine.CURVE_SPLINE) {
                ...
                var tension = (this._curve.type === engine.CURVE_CATMULL) ? 0.5 : this._curve.tension;
