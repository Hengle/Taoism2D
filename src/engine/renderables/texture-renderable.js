...
function TextureRenderable(myTexture) {
    ...
    Renderable.prototype._setShader.call(this, engine.defaultResources.getTextureShader());
...
engine.core.inheritPrototype(TextureRenderable, Renderable);




TextureRenderable.prototype.draw = function (aCamera) {
    engine.Textures.activateTexture(this.mTexture);
...
TextureRenderable.prototype.setTexture = function (newTexture) {
    ...
    this.mTextureInfo = engine.Textures.getTextureInfo(newTexture);
    this.mColorArray = null;
