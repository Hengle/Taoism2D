Object.assign(engine, (function () {
    ...
    Object.assign(Vec3.prototype, {
        /**
         * @function
         * @name engine.Vec3#add
         * @description Adds a 3-dimensional vector to another in place.
         * @param {engine.Vec3} rhs The vector to add to the specified vector.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var a = new engine.Vec3(10, 10, 10);
         * var b = new engine.Vec3(20, 20, 20);
         *
         * a.add(b);
         *
        ...
        /**
         * @function
         * @name engine.Vec3#add2
         * @description Adds two 3-dimensional vectors together and returns the result.
         * @param {engine.Vec3} lhs The first vector operand for the addition.
         * @param {engine.Vec3} rhs The second vector operand for the addition.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var a = new engine.Vec3(10, 10, 10);
         * var b = new engine.Vec3(20, 20, 20);
         * var r = new engine.Vec3();
         *
         * r.add2(a, b);
         * // Should output [30, 30, 30]
         *
        ...
        /**
         * @function
         * @name engine.Vec3#clone
         * @description Returns an identical copy of the specified 3-dimensional vector.
         * @returns {engine.Vec3} A 3-dimensional vector containing the result of the cloning.
         * @example
         * var v = new engine.Vec3(10, 20, 30);
         * var vclone = v.clone();
        ...
        /**
         * @function
         * @name engine.Vec3#copy
         * @description Copied the contents of a source 3-dimensional vector to a destination 3-dimensional vector.
         * @param {engine.Vec3} rhs A vector to copy to the specified vector.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var src = new engine.Vec3(10, 20, 30);
         * var dst = new engine.Vec3();
         *
         * dst.copy(src);
         *
        ...
        /**
         * @function
         * @name engine.Vec3#cross
         * @description Returns the result of a cross product operation performed on the two specified 3-dimensional vectors.
         * @param {engine.Vec3} lhs The first 3-dimensional vector operand of the cross product.
         * @param {engine.Vec3} rhs The second 3-dimensional vector operand of the cross product.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var back = new engine.Vec3().cross(engine.Vec3.RIGHT, engine.Vec3.UP);
         *
         * // Should print the Z axis (i.e. [0, 0, 1])
         * console.log("The result of the cross product is: " + back.toString());
         */
        cross: function (lhs, rhs) {
            // Create temporary letiables in case lhs or rhs are 'this'
            var lx = lhs.x;
            var ly = lhs.y;
            var lz = lhs.z;
            var rx = rhs.x;
        ...
        /**
         * @function
         * @name engine.Vec3#dot
         * @description Returns the result of a dot product operation performed on the two specified 3-dimensional vectors.
         * @param {engine.Vec3} rhs The second 3-dimensional vector operand of the dot product.
         * @returns {Number} The result of the dot product operation.
         * @example
         * var v1 = new engine.Vec3(5, 10, 20);
         * var v2 = new engine.Vec3(10, 20, 40);
        ...
        /**
         * @function
         * @name engine.Vec3#equals
         * @description Reports whether two vectors are equal.
         * @param {engine.Vec3} rhs The vector to compare to the specified vector.
         * @returns {Boolean} true if the vectors are equal and false otherwise.
         * @example
         * var a = new engine.Vec3(1, 2, 3);
         * var b = new engine.Vec3(4, 5, 6);
        ...
        /**
         * @function
         * @name engine.Vec3#lerp
         * @description Returns the result of a linear interpolation between two specified 3-dimensional vectors.
         * @param {engine.Vec3} lhs The 3-dimensional to interpolate from.
         * @param {engine.Vec3} rhs The 3-dimensional to interpolate to.
         * @param {Number} alpha The value controlling the point of interpolation. Between 0 and 1, the linear interpolant
         * will occur on a straight line between lhs and rhs. Outside of this range, the linear interpolant will occur on
         * a ray extrapolated from this line.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var a = new engine.Vec3(0, 0, 0);
         * var b = new engine.Vec3(10, 10, 10);
         * var r = new engine.Vec3();
         *
        ...
        /**
         * @function
         * @name engine.Vec3#mul
         * @description Multiplies a 3-dimensional vector to another in place.
         * @param {engine.Vec3} rhs The 3-dimensional vector used as the second multiplicand of the operation.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var a = new engine.Vec3(2, 3, 4);
         * var b = new engine.Vec3(4, 5, 6);
         *
         * a.mul(b);
         *
        ...
        /**
         * @function
         * @name engine.Vec3#mul2
         * @description Returns the result of multiplying the specified 3-dimensional vectors together.
         * @param {engine.Vec3} lhs The 3-dimensional vector used as the first multiplicand of the operation.
         * @param {engine.Vec3} rhs The 3-dimensional vector used as the second multiplicand of the operation.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var a = new engine.Vec3(2, 3, 4);
        ...
        /**
         * @function
         * @name  engine.Vec3#project
         * @description Projects this 3-dimensional vector onto the specified vector.
         * @param {engine.Vec3} rhs The vector onto which the original vector will be projected on.
         * @returns {engine.Vec3} Self for chaining.
         * @example
         * var v = new engine.Vec3(5, 5, 5);
         * var normal = new engine.Vec3(1, 0, 0);
         *
         * v.project(normal);
         *
         * // Should output 5, 0, 0
        ...
        /**
         * @function
         * @name engine.Vec3#toString
         * @description Converts the vector to string form.
         * @returns {String} The vector in string form.
         * @example
         * var v = new engine.Vec3(20, 10, 5);
     ...
     * @example
     * var vec = new engine.Vec3(10, 20, 30);
     *
     * // Get x
     * var x = vec.x;
     *
