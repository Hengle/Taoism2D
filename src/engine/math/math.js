...
engine.math = {
    /**
     * @name engine.math.DEG_TO_RAD
     * @description Conversion factor between degrees and radians
     * @type Number
     * @example
     * // Convert 180 degrees to pi radians
     * var rad = 180 * engine.math.DEG_TO_RAD;
     */
    DEG_TO_RAD: Math.PI / 180,

    /**
     * @name engine.math.RAD_TO_DEG
     * @description Conversion factor between degrees and radians
     * @type Number
     * @example
     * // Convert pi radians to 180 degrees
     * var deg = Math.PI * engine.math.RAD_TO_DEG;
     */
    RAD_TO_DEG: 180 / Math.PI,

    /**
     * @function
     * @name engine.math.clamp
     ...
     * var bytes = engine.math.intToBytes24(0x112233);
     */
    ...
    /**
     * @function
     * @name engine.math.bytesToInt24
     * @description Convert 3 8 bit Numbers into a single unsigned 24 bit Number.
     * @example
     * // Set result1 to 0x112233 from an array of 3 values
     * var result1 = engine.math.bytesToInt24([0x11, 0x22, 0x33]);
     *
     * // Set result2 to 0x112233 from 3 discrete values
     * var result2 = engine.math.bytesToInt24(0x11, 0x22, 0x33);
     ...
     * var result1 = engine.math.bytesToInt32([0x11, 0x22, 0x33, 0x44]);
     *
     * // Set result2 to 0x11223344 from 4 discrete values
     * var result2 = engine.math.bytesToInt32(0x11, 0x22, 0x33, 0x44);
     * @param {Number} r A single byte (0-255)
     * @param {Number} g A single byte (0-255)
     * @param {Number} b A single byte (0-255)
    ...
    lerp: function (a, b, alpha) {
        return a + (b - a) * engine.math.clamp(alpha, 0, 1);
    },

    /**
     * @function
     * @name engine.math.lerpAngle
    ...
    lerpAngle: function (a, b, alpha) {
        ...
        return engine.math.lerp(a, b, engine.math.clamp(alpha, 0, 1));
    },

    /**
     * @function
     * @name engine.math.powerOfTwo
    ...
    /**
     * @function
     * @name engine.math.nextPowerOfTwo
    ...
    /**
     * @function
     * @name engine.math.smootherstep
     * @description An improved version of the engine.math.smoothstep function which has zero
