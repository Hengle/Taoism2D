Object.assign(engine, (function () {
    ...
    /**
     * @enum engine.CURVE
     * @name engine.CURVE_LINEAR
     * @description A linear interpolation scheme.
     */
    var CURVE_LINEAR = 0;
    /**
     * @enum engine.CURVE
     * @name engine.CURVE_SMOOTHSTEP
    ...
    var Curve = function (data) {
        ...
        this._eval = new engine.CurveEvaluator(this);
    ...
    Object.assign(Curve.prototype, {
        ...
        /**
         * @function
         * @name engine.Curve#clone
         * @description Returns a clone of the specified curve object.
         * @returns {engine.Curve} A clone of the specified curve
         */
        clone: function () {
            var result = new engine.Curve();
            result.keys = engine.extend(result.keys, this.keys);
         ...
         * @private
         * @function
         * @name engine.Curve#quantizeClamped
         * @description Sample the curve at regular intervals over the range [0..1]
