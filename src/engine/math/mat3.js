Object.assign(engine, (function () {
    ...
    Object.assign(Mat3.prototype, {
        /**
         * @function
         * @name engine.Mat3#clone
         * @description Creates a duplicate of the specified matrix.
         * @returns {engine.Mat3} A duplicate matrix.
         * @example
         * var src = new engine.Mat3().translate(10, 20, 30);
         * var dst = src.clone();
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"));
         */
        clone: function () {
            return new engine.Mat3().copy(this);
        },

        /**
         * @function
         * @name engine.Mat3#copy
         * @description Copies the contents of a source 3x3 matrix to a destination 3x3 matrix.
         * @param {engine.Mat3} rhs A 3x3 matrix to be copied.
         * @returns {engine.Mat3} Self for chaining
         * @example
         * var src = new engine.Mat3().translate(10, 20, 30);
         * var dst = new engine.Mat3();
         * dst.copy(src);
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"));
         */
        copy: function (rhs) {
        ...
        /**
         * @function
         * @name engine.Mat3#equals
         * @param {engine.Mat3} rhs The other matrix.
         * @description Reports whether two matrices are equal.
         * @returns {Boolean} true if the matrices are equal and false otherwise.
         * @example
         * var a = new engine.Mat3().translate(10, 20, 30);
         * var b = new engine.Mat3();
